...
<b>apiserver_host_ip = 10.190.22.10</b> and <b>apiserver_host_port = 6443</b> : These parameters are to access K8S API. In this lab there is a single master node hence its IP address is used here.
